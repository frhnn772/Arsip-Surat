                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="example3" class="display" style="width:95%">
                            ...
                            <tbody>
                            <?php
                                $query = $con->query("SELECT * FROM srt_msk");
                                $no = 1;
                            ...
                            ?>
                                <tr>
                                    ...
                                    <?php 
                                        ...
                                        if($level == "admin") {
                                    ?>
                                        <a href="berkas/masuk/<?php echo $data['file']; ?>" target="_blank" class="btn btn-primary shadow btn-xs sharp me-1"><i class="fa fa-file-pdf"></i></a>
                                        <a href="proses/m-hapus.php?del=<?php echo $data['id'] ?>" onClick="return confirm('Yakin Ingin Hapus Surat Dari <?php echo $data['asal_srt']?> ?')" class="btn btn-danger shadow btn-xs sharp"><i class="fa fa-trash"></i></a>
                                    <?php
                                    }else{
                                    ?> 
                                        <a href="berkas/masuk/<?php echo $data['file']; ?>" target="_blank" class="btn btn-primary shadow btn-xs sharp me-1"><i class="fa fa-file-pdf"></i></a>
...
<div class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        ...
        <form action="proses/m-proses.php" method="POST" enctype="multipart/form-data">
            <div class="modal-body">
                <label for="no_srt" class="mb-1">Nomor Surat</label>
                <input type="text" class="form-control input-rounded" placeholder="Masukkan Nomor Surat" name="no_srt" required>
            
                <label for="asal_srt" class="mb-1">Asal Surat</label>
                <input type="text" class="form-control input-rounded" placeholder="Masukkan Asal Surat" name="asal_srt" required>
                
                <label for="tgl_srt" class="mb-1">Tanggal Surat</label>
                <input type="text" class="datepicker-default form-control input-rounded" id="datepicker" placeholder="Masukkan Tanggal Surat" name="tgl_srt">
                
                <label for="ket" class="mb-1">Perihal</label>
                <textarea type="text" class="form-control" id="validationCustom04" rows="5" placeholder="Masukkan Perihal" name="perihal" required></textarea>
                
                <label for="asal_srt" class="mb-1">Keterangan</label>
                <input type="text" class="form-control input-rounded" placeholder="Masukkan Keterangan" name="ket" required>
